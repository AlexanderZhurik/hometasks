...
namespace _17._03._22
{
    class Program
    {
        static void Main(string[] args)
        {
            // я же могу в домашках не заморачиваться с вводом массива с клавиатуры? это же ужас капец долго
            int[] task1 = new int[] { 3, 38, -4, 0, 324, 84, 57, 79, 321 };
            ...
            int[] task2 = new int[] { -255, 215, -133, -142, -428, -20, -39, 438, 274 };
            Console.WriteLine("\n\nSecond task");
