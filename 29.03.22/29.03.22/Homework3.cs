...
namespace Homework3
{
    ...
    {
        static public void DivisibleByA()
        {
        ...
        static public void SquareLessThanA()
        {
            Console.WriteLine("\n\nSecond task");
            Console.WriteLine("Enter the number");
        ...
        static public void LargestDivisorOfA()
        {
            Console.WriteLine("\n\nThird task");
            Console.WriteLine("Enter the number");
        ...
        static public void IsDivisibleBySeven()
        {
            Console.WriteLine("\n\nFourth task");
        ...
        static public void BiggestDivisor()
        {
            Console.WriteLine("\n\nFifth task");
        ...
        static public void NubmerOfOddDigits()
        {
            Console.WriteLine("\n\nSeventh task");
            Console.WriteLine("Enter the number");
        ...
        static public void MirrorTheNumber()
        {
            Console.WriteLine("\n\nEighth task");
